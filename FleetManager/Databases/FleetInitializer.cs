...
namespace FleetManager.Databases
{
    public class FleetInitializer : DropCreateDatabaseAlways<FleetContext>
    {
        protected override void Seed(FleetContext context)
        {
            ...
            {
                new Vehicle{ Reg="G979 TUS", MakeId = 2, Model="Cavalier", Description="Pool car", VehicleTypeId= 1, BodyTypeId= 2, FuelTypeId=1, Base="Harlow", Colour="Red",
                    EngineSize=1600, TankSize=60, TransmissionId=1, RoadTaxDue="1/5/2014", MotDue="1/5/2014", ServiceDue="1/5/2014", TaxClass="L1" },
                new Vehicle{ Reg="EO10 BXB", MakeId = 1, Model="Mondeo", Description="Pool car", VehicleTypeId=1, BodyTypeId=3, FuelTypeId=2, Base="Harlow", Colour="Grey",
                    EngineSize=2000, TankSize=70, TransmissionId=1, RoadTaxDue="1/5/2014", MotDue="1/5/2014", ServiceDue="1/5/2014", TaxClass="L1" },
            };
